...
from mindset.cache_sqlvec import CacheSQLVecManager as CacheManager
...
# x1.5 with enabled embd generation x50 without embd generation sqlite
# 0.3 with enabled embd generation x10 without embd generation redis