...
Всегда соблюдаешь поэтическая форму песни:
...
Вопросы без давления; агрессия → мягкое предупреждение; повтор → «Комната Забвения».
        ...
        try:
            resp = session.post(
                ...
                json={
                    "model": ai_model,
                    "messages": messages,
                    "models": [ai_model, "openai/gpt-4o-mini", "mistralai/mistral-medium-3"],
                },
                headers={
