...
class LLMManager:
    ...
    def llm_response(self, user_message: str, system_message: str, is_json_response: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            if is_json_response:
                return self.utils.clean_json_string(content)
            return json.loads(content)
        except Exception as e:
            self.logger.error("LLM one call failed: %s", e)
            return {"error": str(e)}

    def llm_conversation(self, messages: List[Dict[str, str]], system_message: str, is_json_response: bool = False) -> Dict[str, Any]:
    ...
    def llm_call(self, messages: List[Dict[str, str]], chat_id: str, tg_user_id: str, moderate_user_callback=None, is_json_response: bool = False) -> str:
        """
