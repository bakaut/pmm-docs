#!/usr/bin/env python3
"""
Test script to demonstrate all possible formatting tags in Telegraph articles.
...
def main():
    ...
    # Create a minimal config with the provided access token
    config_dict = {
        "bot_token": "dummy_token",  # Required but not used for this test
        ...
        "database_url": "postgresql://dummy:dummy@localhost/dummy",  # Required but not used
        "operouter_key": "dummy_key",  # Required but not used
        "suno_api_key": "dummy_suno_key"  # Required but not used
    }
    ...
    page = telegraph.create_page(
        tg_id=123456789,  # Dummy Telegram user ID
        chat_id=987654321,  # Dummy chat ID
