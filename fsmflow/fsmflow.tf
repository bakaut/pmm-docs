...
resource "yandex_function" "function_flow" {
  ...
  environment = {
    ...
    ydb_endpoint         = yandex_ydb_database_serverless.cache_db_dev.ydb_full_endpoint
    ydb_database         = yandex_ydb_database_serverless.cache_db_dev.database_path
    ydb_cache_table      = yandex_ydb_table.cache_table_dev.path
  }
  content {
